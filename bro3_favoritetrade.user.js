...
function favorite_trade(){
	...
	function set_favorite(){
		...
		document.getElementById("save_num").addEventListener("click",function(){save_num();favorite_set_display();},false)
		document.getElementById("save_list").addEventListener("click",function(){save_list();favorite_set_display();},false)
		document.getElementById("save_num2").addEventListener("click",function(){save_num();favorite_set_display();},false)
		document.getElementById("save_list2").addEventListener("click",function(){save_list();favorite_set_display();},false)
...
function AutoDelete(){
	var type = document.getElementsByTagName("h3").item(0).innerHTML;
				...
				for( var j = 3; j < 6; j++ ){
					...
					if(sk_name.snapshotItem(i).innerHTML.length != 0){
						...
						if(skill_list.match(regexp) && sk_flg.snapshotItem(i).className != "used"){
							...
							btn.addEventListener("click",AH_setDeck(b_id[i],j-3),false)
